...
def encoding_from_annotation(
    f: _get_type_hints_obj_allowed_types, offset: int = 1
) -> list[Any]: ...
...
class ObjCMethod:
    ...
    ) -> ctypes.c_void_p | Any | type[ObjCClass] | ObjCInstance | None:
...
class ObjCPartialMethod:
    _sentinel = ...
    def __init__(self, name_start: str) -> None: ...
    def __repr__(self) -> str: ...
    def __call__(
        self, receiver: ObjCInstance, first_arg: Any = _sentinel, **kwargs: Any
    ) -> Any: ...
...
class ObjCBoundMethod:
    ...
    def __init__(self, method: Callable[..., Any], receiver: ObjCInstance) -> None:
...
def convert_method_arguments(
    encoding: Iterable[type[Any]], args: Iterable[Any]
) -> list[Any]:
...
class objc_classmethod:
    ...
    def __call__(
        self, objc_cls: ObjCInstance | objc_id, objc_cmd: Any, *args: Any
    ) -> int | Any | ObjCBoundMethod | None: ...
    def class_register(
        self, class_ptr: ObjCInstance | objc_id, attr_name: str
    ) -> None: ...
    def protocol_register(
        self, proto_ptr: ObjCInstance | objc_id, attr_name: str
    ) -> None: ...
...
class objc_ivar:
    ...
    """
    def __init__(self, vartype: type[Any]) -> None: ...
    def class_register(
        self, class_ptr: ObjCInstance | objc_id, attr_name: str
    ) -> Any: ...
    def protocol_register(
...
class objc_property:
    ...
    types.
    """
    def __init__(self, vartype: type[Any] = objc_id, weak: bool = False) -> None: ...
    def class_register(
        self, class_ptr: ObjCInstance | objc_id, attr_name: str
    ) -> None: ...
    def dealloc_callback(
        self, objc_self: ObjCInstance | objc_id, attr_name: str
    ) -> None: ...
    def protocol_register(
        self, proto_ptr: ObjCInstance | objc_id, attr_name: str
    ) -> None: ...
...
def type_for_objcclass(objcclass: ObjCClass) -> type[ObjCInstance]:
...
def register_type_for_objcclass(pytype: type[Any], objcclass: ObjCClass) -> None:
...
def unregister_type_for_objcclass(objcclass: ObjCClass) -> None:
...
def for_objcclass(objcclass: ObjCClass) -> Callable[[_T], _T]:
...
class ObjCInstance:
    ...
    _instance_lock = ...
    @property
    def objc_class(self) -> ObjCClass:
        """The Objective-C object's class, as an :class:`ObjCClass`."""

    def __new__(
        cls,
        object_ptr: ObjCInstance | objc_id | ctypes.c_void_p,
        _name: str | None = None,
    ...
    def __getattr__(self, name: str) -> ObjCBoundMethod | Any:
...
class ObjCClass(ObjCInstance, type):
    ...
    @property
    def protocols(self) -> tuple[Any | type[ObjCClass] | None, ...]:
    ...
    def declare_property(self, name: str) -> None:
    ...
    def declare_class_property(self, name: str) -> None:
...
class ObjCMetaClass(ObjCClass):
    ...
    """
    def __new__(
        cls, name_or_ptr: str | bytes | ObjCInstance
    ) -> type[ObjCMetaClass] | type[ObjCClass] | None:
...
if TYPE_CHECKING:
    _ConvertablePyType: TypeAlias = (
        ...
        | bytes
        | Decimal
        | dict[_ConvertablePyType, _ConvertablePyType]
        | list[_ConvertablePyType]
        | bool
        | int
        | float
    )
...
def ns_from_py(
    pyobj: _ConvertablePyType,
) -> Any | ObjCInstance | type[ObjCClass] | None:
...
def create_block_descriptor_struct(
    has_helpers: bool, has_signature: bool
) -> type[ObjCBlockDescriptor]: ...
def cast_block_descriptor(block: ObjCBlock) -> ctypes._Pointer[ObjCBlockDescriptor]: ...

AUTO = ...

class BlockConsts:
    HAS_COPY_DISPOSE: Final[int] = ...
    HAS_CTOR: Final[int] = ...
    IS_GLOBAL: Final[int] = ...
    HAS_STRET: Final[int] = ...
    HAS_SIGNATURE: Final[int] = ...
...
class ObjCBlock:
    ...
    """
    def __init__(
        self, pointer: ObjCInstance | objc_id, restype: Any = AUTO, *argtypes: Any
    ) -> None:
...
class Block:
    ...
    _keep_alive_blocks_ = ...
    def __init__(
        self, func: Callable[..., Any], restype: Any = NOTHING, *argtypes: Any
    ) -> None:
    ...
    def wrapper(self, block: Block, *args: Any) -> Any: ...
    def dispose_helper(self, dst: Hashable) -> None: ...
    def copy_helper(self, dst: Hashable, src: Any) -> None: ...
