...
import sys
from asyncio import AbstractEventLoop, events, unix_events
...
class CFSocketHandle(events.Handle):
    def __init__(self, *, loop: AbstractEventLoop, fd: FileDescriptorLike) -> None:
    ...
    def enable_read(self, callback: Callable[..., object], args: Sequence[Any]) -> None:
    ...
    def enable_write(
        self, callback: Callable[..., object], args: Sequence[Any]
    ) -> None:
...
def context_callback(
    context: Context, callback: Callable[..., None]
) -> Callable[..., None]: ...

class CFEventLoop(unix_events.SelectorEventLoop):
    def __init__(self, lifecycle: CFLifecycle | None = None) -> None: ...
    def __del__(self) -> None: ...
    def add_reader(
        self, fd: FileDescriptorLike, callback: Callable[..., object], *args: Any
    ) -> None:
    ...
    def run_until_complete(self, future: Any, **kw: Any) -> Any:
    ...
    def run_forever(self, lifecycle: CFLifecycle | None = None) -> None:
        """Run until stop() is called."""
        ...

    def run_forever_cooperatively(self, lifecycle: CFLifecycle | None = None) -> None:
    ...
    def call_soon(
        self, callback: Callable[..., object], *args: Any, context: object = ...
    ) -> CFTimerHandle:
...
if sys.version_info < (3, 16):
    from asyncio import (
        AbstractEventLoopPolicy,  # type: ignore
    )

    class EventLoopPolicy(AbstractEventLoopPolicy):  # pyright: ignore[reportUntypedBaseClass]
...
class CFLifecycle:
    ...
    def __init__(self, cfrunloop: CFRunLoopRef) -> None: ...
    def start(self) -> None: ...
    def stop(self) -> None: ...
